...
<head>
  ...
  <title>C-Withdraw</title>
</head>
<body>
<img class="logoimg" src= "images/DKB-Bank-Logo.png">
  <div class="sign">
    <form method = "post">
      <center><h1>Cash-Withdraw Page</h1></center>
      <lable for = "cash">Enter amount to withdraw:</lable>
...
<?php
    ...
    if($cbalance<$amt1){
      echo "<script>alert('Balance insufficient');</script>";
      exit();
      session_destroy();
    }
    $amt1 = $cbalance-$amt1;
    ...
    echo "<script>alert('Withdraw Sucessfull');</script>";
  }
  ?>